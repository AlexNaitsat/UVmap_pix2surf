## Fix for Mac OS Big Sur - Starts #substitute ~/anaconda3/envs/pix2surf/lib/python3.6/site-packages/tk3dv/common/drawing.py with this file
try:
...
# QUADRIC = glu.gluNewQuadric() #commented to avoid:  OpenGL.error.NullFunctionError: Attempt to call an undefined function gluNewQuadric
