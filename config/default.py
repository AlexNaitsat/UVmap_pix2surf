...
def get_default_cfg():
    ...
    #additional parameters for  'pix2surf_mv_xyz_uv_diff' model
    cfg.XYZ_UV_DIFF_ALPHA = 0.1
    cfg.XYZ_UV_DIFF_COEF  = 0.1

    #param to disable data shuffling in training  to make it deterministic 
    cfg.SHUFFLE = True
    return cfg
